...
/// This class represents a position and a velocity, to which physics simulations can be applied.
/**
...
public:
    ...
    /// Represents the position of the RigidBody
    vec3 position = vec3(0.0);
    /// Represents the velocity of the RigidBody
